...
- **142 diversions**, from cellular automata and reaction-diffusion to
...
- **`meta.ts`** — the identity (`id`, `title`, `description`, `kind`). Eagerly loaded, so the gallery can lay out all 140 tiles on the first paint.
