...
export function makeGLContext(): MockGLContext {
  ...
  const gl = {
    ...
    uniform1iv: rec('uniform1iv'),
    uniform3iv: rec('uniform3iv'),
    uniform4iv: rec('uniform4iv'),
    uniform2f: rec('uniform2f'),
    uniform2fv: rec('uniform2fv'),
    ...
    uniform3i: rec('uniform3i'),
    uniform4i: rec('uniform4i'),
    uniformMatrix2fv: rec('uniformMatrix2fv'),
    uniformMatrix3fv: rec('uniformMatrix3fv'),
