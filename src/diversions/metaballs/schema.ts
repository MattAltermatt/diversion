...
export const metaballsSchema = z.object({
  blobCount: z.number().int().min(3).max(16).default(8)
    .meta({ section: 'Blobs', ui: 'slider', min: 3, max: 16, step: 1, label: 'Blob count',
