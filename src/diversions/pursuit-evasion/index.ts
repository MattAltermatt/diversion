...
import { pursuitEvasionSchema, type PursuitEvasionConfig } from './schema'
...
// Population sizes, brain shape, and the seed rebuild the arms race; the rest —
// physics tunables, evolution rates, colours, speed — applies live to the run.
...
const pursuitEvasion = defineDiversion<typeof pursuitEvasionSchema, State, '2d'>({
  ...
  frame(state, ctx, _t, dt) {
    ...
    // teleport creatures through each other.
